...
export default function Mobile_nav() {
  return (
    <div>
      <nav className="w-full border-gray-200 px-2 dark:border-gray-700 dark:bg-gray-900 md:hidden">
                      ...
                      >
                        ...
                        >
                          <li>
                            <a
                              href="#"
                              className="block px-4 py-2 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white"
                            >
                              Overview
                            </a>
                          </li>
